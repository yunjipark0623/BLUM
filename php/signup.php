<?php
  ...
  $id_check_sql = "SELECT * FROM member WHERE id='$user_id'";
  ...
  $insert_sql = "INSERT INTO member (ID,PW,Name,Phone,Addr,Mail) VALUES ('$user_id',password('$userpw'),'$username','$userphone','$useraddr','$usermail')";
